...
<div class="mb-6">
    <h1 class="text-3xl font-bold text-dracula-pink mb-2">Polls</h1>
...
<?php if ($activePoll): ?>
    <!-- Active Poll Section -->
    <div class="mb-8">
        <h2 class="text-2xl font-bold text-dracula-green mb-4">Current Active Poll</h2>
        <div class="bg-dracula-currentLine shadow-md rounded-lg overflow-hidden">
            <div class="p-6">
                <h3 class="text-2xl font-semibold text-dracula-cyan mb-2"><?php echo htmlspecialchars($activePoll['title']); ?></h3>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <a href="view_poll.php?id=<?php echo $activePoll['id']; ?>" class="bg-dracula-green text-dracula-bg px-6 py-3 rounded text-lg font-medium hover:bg-dracula-green/80 transition-colors">Vote Now</a>
                </div>
            </div>
        </div>
    </div>
...
<?php elseif (!empty($inactivePollsData)): ?>
    <!-- Other Polls Section -->
    <div class="mt-8">
        <h2 class="text-2xl font-bold text-dracula-purple mb-4">Previous Polls</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php foreach ($inactivePollsData as $poll): ?>
                <div class="bg-dracula-currentLine shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    <div class="p-6">
                        <h3 class="text-xl font-semibold text-dracula-cyan mb-2"><?php echo htmlspecialchars($poll['title']); ?></h3>
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="view_poll.php?id=<?php echo $poll['id']; ?>" class="bg-dracula-purple text-dracula-bg px-4 py-2 rounded text-sm hover:bg-dracula-pink">View Results</a>
                        </div>
                    </div>
                </div>
            <?php endforeach; ?>
...
<div class="mt-8 text-center">
    ...
    <a href="admin/login.php" class="bg-dracula-purple text-dracula-bg px-6 py-3 rounded-lg text-lg font-medium hover:bg-dracula-pink transition-colors duration-300">Admin Login</a>
</div>
